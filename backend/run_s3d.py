...
def load_model_s3d(model_weights_path, device, class_names):
...
def inference(model, device, class_names, input_path, out_dir, out_name, show=False, clip_len=16, img_size=(256, 256), crop_size=(224, 224)):
